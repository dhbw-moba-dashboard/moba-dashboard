...
export const ImageButton: React.FC<ButtonProperties> = (props: ButtonProperties) => {
	return (
		<button id={props.id} onClick={props.buttonAction} className={props.className}>
...
export const GlassMorphButton: React.FC<ButtonProperties> = (props: ButtonProperties) => {
	return (
		<button id={props.id} className={`glass-morph-button-style-properties ${props.className}`} style={props.style} onClick={props.buttonAction}>
			{props.children}
		</button>
	);
};
