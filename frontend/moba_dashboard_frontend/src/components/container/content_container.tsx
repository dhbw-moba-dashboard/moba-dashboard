...
export const ContentContainer: React.FC<ContentContainerProperties> = (props: ContentContainerProperties,) => {
	return (
		<div id={props.id} className={`content-container-style-properties ${props.className}`} style={props.style}>
			<FlexBox style={{justifyContent: 'space-between', alignItems: 'center'}}>
				<HeaderText style={{textAlign: 'left'}} textValue={props.contentContainerHeaderText}/>
