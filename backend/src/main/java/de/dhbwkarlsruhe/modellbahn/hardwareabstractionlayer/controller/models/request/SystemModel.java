...
public class SystemModel {
    ...
    public record SystemGo() implements Payload {
    ...
    public record SystemStop(int id) implements Payload{

        @Override
        public byte[] toByteArray() {
            byte[] stopCommand = new byte[]{0x00,0x01,0x04, (byte) (0xd2),0x05,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
            return stopCommand;
        }
    }
}
